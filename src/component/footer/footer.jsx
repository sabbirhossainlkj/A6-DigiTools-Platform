        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-4">
            <div className="flex items-center gap-3 mb-6">
              <h2 className="text-3xl md:text-center font-bold tracking-tighter text-white">
                DigiTools
              </h2>
            </div>
          ...
          <div className='md:col-span-2 space-y-3'>
            <p className='text-red-400 font-bold text-xl'>social</p>
            <ul className='flex gap-2 text-white'>
                <li><a href="#"><img src={instagramimg} alt="Facebook" /></a></li>
                <li><a href="#"><img src={facebookimg} alt="Instagram" /></a></li>
                <li><a href="#"><img src={twitterimg} alt="LinkedIn" /></a></li>
            </ul>
          </div>
        </div>
